...
/** Move a real scroll container and let the rAF-throttled coordinator couple the sibling. A live scroll
 *  frame settles in one rAF (rafThrottle → onScroll → couple), so a few frames are ample. */
